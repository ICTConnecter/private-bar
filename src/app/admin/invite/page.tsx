    ...
    <UserAuthComponent>
      <div className="min-h-screen bg-gray-50 p-4">
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardHeader title="ユーザーを招待" subtitle="オーナー専用" />
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    <li>• オーナーが発行した招待URLで登録されたユーザーは承認待ちになります</li>
                    <li>• ユーザー管理画面で承認・却下を行えます</li>
                    <li>• 招待URLは何度でも生成できます</li>
                    <li>• 各招待URLは1回のみ使用可能です</li>
                  </ul>
                </div>
                ...
                <div className="border-t pt-4">
                  <p className="text-sm text-gray-600 mb-3">
                    招待されたユーザーは「申請中」として登録されます。
                    <br />
                    ユーザー管理画面で承認・却下を行ってください。
                  </p>
                  <Button
                    variant="outline"
                    fullWidth
                ...
                <div className="border-t pt-4">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• 招待URLは慎重に共有してください</li>
                    <li>• 各招待URLは1回のみ使用可能です</li>
                    <li>• 不適切なユーザーはブロックすることができます</li>
                  </ul>
                </div>
              </div>
            </CardContent>
